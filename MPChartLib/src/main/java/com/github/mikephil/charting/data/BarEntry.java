...
public class BarEntry extends Entry {
     ...
     * mYVals 是否表示一个一个数据
     */
    private boolean isPresentOneData = true;
     ...
     * @param vals - the stack values, use at least 2
     */
    public BarEntry(float x, float[] vals,boolean presentOne) {
        super(x, calcSum(vals));

        this.mYVals = vals;
        this.isPresentOneData = presentOne;
        calcPosNegSum();
        calcRanges();
    }

    public BarEntry setPresentOneData(boolean presentOneData) {
        isPresentOneData = presentOneData;
        return this;
    }
    ...
    public boolean isPresentOneData() {
        return isPresentOneData;
    }
    ...
    protected void calcRanges() {
        ...
        if(isPresentOneData){
            mRanges = new Range[1];
            mRanges[0] = new Range(values[0], values[0] + values[1]);
        }else {
    ...
    public BarEntry setmDes(String mDes) {
        this.mDes = mDes;
        return this;
    }
}
