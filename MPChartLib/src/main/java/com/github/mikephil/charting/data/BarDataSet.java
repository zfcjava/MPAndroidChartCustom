...
public class BarDataSet extends BarLineScatterCandleBubbleDataSet<BarEntry> implements IBarDataSet {
    ...
    private boolean isPresentOneData = false;
    private boolean isDrawDesEnable = false;
    /**
     * the typeface used for the value text
     */
    protected Typeface mDesTypeface;

    /**
     * the size of the value-text labels
     */
    protected float mDesTextSize = 17f;
    ...
    private void calcStackSize(List<BarEntry> yVals) {
        ...
        for (int i = 0; i < yVals.size(); i++) {
            ...
            isPresentOneData = yVals.get(i).isPresentOneData();
     ...
     * @param vals
     */
    private void checkData(float[] vals) {
        if(vals==null||vals.length!=2){
            throw new InvalidParameterException("getYVals() must be return float[2]");
        }
    }
    ...
    public int getStackSize() {
        return isPresentOneData?1:mStackSize;
    }
    ...
    @Override
    public boolean isDrawDesEnabled() {
        return isDrawDesEnable;
    }

    @Override
    public int getDesTextColor(int index) {
        return mDesColor;
    }

    public void setmDesColor(int mDesColor) {
        this.mDesColor = mDesColor;
    }

    public BarDataSet setDrawDesEnable(boolean drawDesEnable) {
        isDrawDesEnable = drawDesEnable;
        return this;
    }
     ...
     * @return
     */
    public Typeface getDesTypeface(){
        return mDesTypeface;
    }
    ...
    public void setmDesTypeface(Typeface mValueTypeface) {
        this.mDesTypeface = mValueTypeface;
    }

    public void setmDesTextSize(float mValueTextSize) {
        this.mDesTextSize = mValueTextSize;
    }
}
