...
public abstract class DataRenderer extends Renderer {
     ...
     * @param set
     */
    protected void applyDesTextStyle(IDataSet set) {
        if(set instanceof BarDataSet){
            mValuePaint.setTypeface(((BarDataSet)set).getDesTypeface());
            mValuePaint.setTextSize(((BarDataSet)set).getDesTextSize());
        }
    }
