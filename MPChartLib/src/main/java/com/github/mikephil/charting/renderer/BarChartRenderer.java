...
public class BarChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    public BarChartRenderer(BarDataProvider chart, ChartAnimator animator,
        ...
        mDesPaint.setColor(Color.rgb(63, 63, 63));
        mDesPaint.setTextAlign(Paint.Align.CENTER);
        mDesPaint.setTextSize(Utils.convertDpToPixel(9f));
    ...
    public void drawDes(Canvas c, String valueText, float x, float y, int color) {
        mDesPaint.setColor(color);
        c.drawText(valueText, x, y, mDesPaint);
    }
    @Override
